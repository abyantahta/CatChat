...
const Register = () => {
  ...
  const registerHandler = ()=> {
    ...
    if(password !== confirmPassword){
      setMessageError('Please re-enter your confirm password')
    }
    setMessageError('')
    ...
    <div className="container px-8 relative text-4xl font-bold font-title  w-[600px] mx-auto h-[1100px] border-4 border-slate-950">
        ...
        <div className="screen">
            ...
            <form className='mt-8' action="">
              ...
              <h3 className='text-3xl mt-8 font-semibold'>Confirm Password</h3>
              <input onChange={(e)=>setConfirmPassword(e.target.value)}  placeholder='Enter your username' required className='pl-4 py-4 mt-3 font-medium w-full rounded-xl text-2xl outline-none border-2 border-slate-400' type="password" />
            </form>
            <div className="buttonArea mt-12">
              <button onClick={registerHandler} className='w-full inline-block text-center bg-biru py-5 text-white text-2xl rounded-xl duration-75 hover:brightness-125 hover:duration-75'>
              Sign up
              </button>
